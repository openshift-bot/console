...
#
# go backend build
FROM registry.ci.openshift.org/ocp/builder:rhel-9-golang-1.26-openshift-4.23 AS gobuilder
...
FROM registry.ci.openshift.org/ocp/builder:rhel-9-base-nodejs-openshift-4.23 AS nodebuilder
